...
module.exports.getProducts = async (req,res,next)=>{
    try{
        ...
        res.render('shop/products',{products,isAdmin:req.user.isAdmin,cartCount:req.user.cart.products.length});
    }
    catch(err){
        next(err)
    }
...
module.exports.getProductDetails = async (req,res,next)=>{
    ...
    try{
        ...
        res.render('shop/productdetails',{product:products[0],isAdmin:req.user.isAdmin,cartCount:req.user.cart.products.length})
    }
    catch(err){
        next(err);
    }
